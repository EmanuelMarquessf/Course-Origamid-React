...
function Pokemon({pokemon, onButtonClick}) {
  ...
  return (
    <>{pokemon && (
      <div className='flex flex-col items-end border w-[250px] py-1 px-2 bg-r3 border-r5 rounded-sm'>
        ...
        <div className='flex flex-col gap-1 w-full items-center '>
          ...
          {!loading ? (
            <img src={pokemon.sprites.other["official-artwork"].front_default} className='flex justify-end bg-slate-100  w-full h-56 rounded-sm border border-r5'></img>
          ) : (
